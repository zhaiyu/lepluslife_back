...
public class GrouponOrderExcel extends AbstractExcelView {
    ...
    public void setExcelHeader(HSSFSheet excelSheet) {
        ...
        excelHeader.createCell(11).setCellValue("状态");
        excelHeader.createCell(12).setCellValue("下单时间");
        excelHeader.createCell(13).setCellValue("支付完成时间");
    }
    ...
    public void setExcelRows(HSSFSheet excelSheet, List<GrouponOrder> orderList) {
        ...
        for (GrouponOrder order : orderList) {
            ...
            // 下单时间
            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            excelRow.createCell(12).setCellValue(sdf.format(order.getCreateDate()));
            //  支付完成时间
            if (order.getCompleteDate() != null) {
                excelRow.createCell(13).setCellValue(sdf.format(order.getCompleteDate()));
            } else {
