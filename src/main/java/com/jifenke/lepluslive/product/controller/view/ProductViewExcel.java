 ...
 */
@Configuration
public class ProductViewExcel extends AbstractExcelView {
    ...
    public void setExcelHeader(HSSFSheet excelSheet) {
        ...
        excelHeader.createCell(4).setCellValue("正常单价");
    ...
    public void setExcelRows(HSSFSheet excelSheet, Map<String, Object> result ) {
        ...
        for (Map map : productList) {
            ...
            excelRow.createCell(4).setCellValue("￥"+Double.valueOf(map.get("minPrice").toString())/100.0+"+"+Double.valueOf(map.get("minScore").toString())/100.0);
