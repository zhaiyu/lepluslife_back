...
public class SalesController {
   ...
   private MerchantService merchantService;
    ...
    public ModelAndView oneMerchantMove(Model model,String merchantId,String salesStaffId1,String salesStaffId2) {
    ...
    public ModelAndView newSalesStaffName(Model model,String salesStaffId,String newSalesStaffName) {
