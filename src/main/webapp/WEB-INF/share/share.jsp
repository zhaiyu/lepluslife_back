            ...
            <div class="container-fluid">
                ...
                <div class="row" style="margin-bottom: 30px">
                    ...
                    <div class="form-group col-md-1">
                        <button class="btn btn-primary" style="margin-top: 24px" onclick="searchShareByCriteria()">查询
                        </button>
                    </div>
                </div>
                <ul id="myTab" class="nav nav-tabs">
                    <li class="active"><a href="#tab1" data-toggle="tab"
                                          onclick="getOffLineOrderShareByType()">全部订单分润</a></li>
...
//                 contentStr += '<td>' + content[i].toLockPartnerManager / 100 + '</td>'
                    ...
                    if (content[i].offLineOrder != null) {
                        contentStr += '<td>' + content[i].offLineOrder.scoreC / 100 + '</td>'
                        contentStr += '<td>' + content[i].offLineOrder.shareMoney / 100 + '</td>'
                        contentStr += '<td>' + content[i].offLineOrder.rebate / 100 + '</td>'
                    }else if(content[i].posOrder != null) {
                        contentStr += '<td>' + content[i].posOrder.scoreC / 100 + '</td>'
                        contentStr += '<td>' + content[i].posOrder.shareMoney / 100 + '</td>'
                        contentStr += '<td>' + content[i].posOrder.rebate / 100 + '</td>'
                    }else {
                        contentStr += '<td>' + 0 + '</td>'
                        contentStr += '<td>' + content[i].shareMoney/100.0 + '</td>'
                        contentStr += '<td>' + 0 + '</td>'
                    }
