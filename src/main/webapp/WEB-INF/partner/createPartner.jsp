  ...
  <div class="m-right">
    <div class="main" >
      <div class="container-fluid">
        <a type="button" class="btn btn-primary btn-return" style="margin:10px;" href="/manage/partner">返回商户列表</a>
        <hr>
        <form class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <input type="text" class="form-control" value="${partner.partnerName}">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label">联系手机号</label>
            <div class="col-sm-4">
              <input type="text" class="form-control" value="${partner.phoneNumber}">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label">锁定店铺上限</label>
            <div class="col-sm-4">
              <input type="text" class="form-control" value="${partner.merchantLimit}">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label">锁定会员上限</label>
            <div class="col-sm-4">
              <input type="text" class="form-control" value="${partner.userLimit}">
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <div class="col-sm-offset-2 col-sm-4">
              <button type="submit" class="btn btn-primary" onclick="submitPartner()">提交</button>
...
<script>
  $("#partnerManager").find("option[value='${partner.partnerManager.id}']").attr("selected", true);
  if(${partner!=null}){
